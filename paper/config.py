...
from slogpet import C_OVER_2
from slogpet.data import load_systems, load_detector_groups, load_styles
...
def group_desc(g):
    ...
    l1 = (r"\textbf{%s}\quad %s mm %s, $\epsilon=%.2f$"
